...
- [ ] **ing M6, L2–L6 — DEFERRED** (VARCHAR(300) title truncation; severity aggregation; keyword-boundary false positives; max-pages; infer fallback). Filed; none block the re-ingest except a nice-to-have on M6 truncation.
...
## 11. Audit 8 — 2026-09-15 RAG / ingestion / vector-DB best-practice pass (inline, no subagents) — ALL 23 CODE ITEMS CLOSED (same day, one commit each); DB-machine ops open; DOG-1 closed 2026-09-16 (5 fixes + follow-ups DOG-1e–h all landed the same day), DOG-2 closed
...
- [ ] **DOG-1 watch items** — Back Extension in 10 of 16 sessions of program 12 (cap accessories per session in the prompt rules if it persists); delete the stale drafts 7–10 for athlete 1 once program 12 has been reviewed in the UI; programs 13 and 15–19 are today's baseline drafts (13 = the aborted first run).
